...
# %%
# watch out with the "value" parameter from the fromKeys, use it with scalar values only, otherwise it will be a pointer to the same collection (dict or list)
my_dict = {"a": 1, "b": 2, "c": 3}
dict.fromkeys(my_dict.keys(), float("inf"))
